...
urlpatterns = [
    ...
    url(r'^faculties/university/(?P<uni_pk>[0-9]+)$', api_views.faculties_university_list),
    url(r'^faculties/(?P<pk>[0-9]+)$', api_views.faculty_instance),
    url(r'^departments/$', api_views.departments_list),
    url(r'^departments/faculty/(?P<fac_pk>[0-9]+)$', api_views.departments_faculty_list),
    url(r'^departments/(?P<pk>[0-9]+)$', api_views.departments_instance),
]
